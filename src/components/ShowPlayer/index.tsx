    ...
    <div className="hidden lg:flex flex-col items-center justify-between px-4 py-4 h-home w-96 text-white bg-gradient-to-t from-gray-800">
      ...
      {isPlaying ? (
        <div className="text-center">
          ...
          />
          <strong className="block font-semibold mt-8 text-xl leading-7">
            {" "}
            Happier Than Ever
          </strong>
          <span className="block mt-4 text-opacity-60 leading-6">
            Billie Eilish
          </span>
        </div>
      ) : (
      ...
      <footer>
        <div className="flex items-center gap-2 text-sm">
          <span className="inline-flex px-2 text-center">
            {converDurationToTimeString(120)}
          </span>
